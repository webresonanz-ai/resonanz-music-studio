                    ...
                    <div class="modal-content">
                        ...
                        <form @submit.prevent="submitEdit">
                            <div class="modal-body">
                                <div v-if="editModal.error" class="alert alert-danger mb-3">{{ editModal.error }}</div>

                                <div class="row g-3">
                                    <div class="col-12 col-sm-6">
                                        <label class="form-label fw-semibold" for="edit-name">Name <span class="text-danger">*</span></label>
                                        <input
                                            id="edit-name"
                                    ...
                                    <div class="col-12 col-sm-6">
                                        <label class="form-label fw-semibold" for="edit-email">Email <span class="text-danger">*</span></label>
                                        <input
                                            id="edit-email"
                                    ...
                                    <div class="col-12 col-sm-6">
                                        <label class="form-label fw-semibold" for="edit-phone">Phone <span class="text-danger">*</span></label>
                                        <input
                                            id="edit-phone"
                                    ...
                                    <div class="col-12 col-sm-6">
                                        <label class="form-label fw-semibold" for="edit-concert">Concert Title <span class="text-danger">*</span></label>
                                        <input
                                            id="edit-concert"
                                    ...
                                    <div class="col-12 col-sm-6">
                                        <label class="form-label fw-semibold" for="edit-qty">Ticket Quantity <span class="text-danger">*</span></label>
                                        <input
                                            id="edit-qty"
                            ...
                            <div class="modal-footer flex-column flex-sm-row gap-2">
                                <button type="button" class="btn btn-outline-secondary w-100 w-sm-auto" @click="closeEditModal">Cancel</button>
                                <button type="submit" class="btn btn-primary w-100 w-sm-auto" :disabled="editModal.loading">
                                    <span v-if="editModal.loading" class="spinner-border spinner-border-sm me-2" aria-hidden="true"></span>
                                    Save Changes
                                </button>
                            </div>
                        </form>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body pt-0">
                            ...
                            <p class="fw-semibold mb-0">{{ deleteModal.audience?.name }} &mdash; {{ deleteModal.audience?.concert_title }}</p>
                        ...
                        <div class="modal-footer border-0 flex-column flex-sm-row gap-2">
                            <button type="button" class="btn btn-outline-secondary w-100 w-sm-auto" @click="closeDeleteModal">Cancel</button>
                            <button type="button" class="btn btn-danger w-100 w-sm-auto" :disabled="deleteModal.loading" @click="executeDelete">
                                <span v-if="deleteModal.loading" class="spinner-border spinner-border-sm me-2" aria-hidden="true"></span>
                                Delete
                            </button>
                        </div>
                    </div>
            ...
            >
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer border-0 flex-column flex-sm-row gap-2">
                            <button type="button" class="btn btn-outline-secondary w-100 w-sm-auto" @click="closeEmailModal">Cancel</button>
                            <button type="button" class="btn btn-info text-white w-100 w-sm-auto" :disabled="emailModal.loading" @click="executeResendEmail">
                                <span v-if="emailModal.loading" class="spinner-border spinner-border-sm me-2" aria-hidden="true"></span>
